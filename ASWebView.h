 ...
 */
@interface ASWebView : UIView <UIWebViewDelegate>
 ...
 */
@property (nonatomic, assign) id<ASWebViewDelegate> delegate;
 ...
 */
- (void)webViewDidStartLoadingPage:(ASWebView *)aWebView;
...
/**
 ...
 @see webViewDidFinishLoadingPage:
 */
- (void)webViewDidLoadDOM:(ASWebView *)aWebView;
 ...
 */
- (void)webViewDidFinishLoadingPage:(ASWebView *)aWebView;
...
/**
 ...
 @see webViewDidFinishLoad:
 */
- (void)webView:(ASWebView *)aWebView didFailLoadWithError:(NSError *)error;
 ...
 */
- (BOOL)webView:(ASWebView *)aWebView shouldStartLoadWithRequest:(NSURLRequest *)aRequest navigationType:(UIWebViewNavigationType)navigationType;
...
/**
 ...
 @see webView:didFailLoadWithError:
 */
- (void)webViewDidFinishLoad:(ASWebView *)aWebView;
...
/**
 ...
 @see webView:didFailLoadWithError:
 */
- (void)webViewDidStartLoad:(ASWebView *)aWebView;
