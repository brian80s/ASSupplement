...
- (void)configureLeftBarButtonUniformly
{
    ...
    self.navigationItem.leftBarButtonItem = [[[UIBarButtonItem alloc] initWithCustomView:[self.view buttonWithFrame:CGRectZero target:self action:@selector(back:) image:[UIImage imageNamed:@"nav_back.png"]]] autorelease];
}
