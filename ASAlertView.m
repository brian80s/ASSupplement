...
- (void)dealloc
{
    [__backgroundImageView release];
    [__titleLabel release];
    [__subtitleLabel release];
    [__textView release];
    ...
    [__titleFont release];
    [__titleTextColor release];
    [__subtitleFont release];
    [__subtitleTextColor release];
    [__buttonTextColor release];
    [__buttonBackgroundImageStateNormal release];
    [__buttonBackgroundImageStateHighlighted release];
    
    [__textViewFont release];
    [__textViewTextColor release];
...
- (void)traverseForTheUsefulItems 
{
    for (UIView *subview in self.subviews) {
        if ([subview isKindOfClass:[UIImageView class]]) {
            ...
            __textView = [(UITextView *)subview retain];
        }
    }
}
